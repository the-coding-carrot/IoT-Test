...
namespace Processor
{
    namespace Distance
    {
        ...
        DistanceProcessor::DistanceProcessor(const StateContext &ctx)
            : ctx_(ctx),
              baseline_cm_(Config::BASELINE_CM),
              trigger_thresh_cm_(Config::BASELINE_CM - Config::TRIGGER_DELTA_CM),
              full_thresh_cm_(Config::BASELINE_CM - (2.0f * Config::TRIGGER_DELTA_CM)),
        ...
        DistanceData DistanceProcessor::Process(const float raw_distance_cm, const uint64_t current_time_us)
        {
            DistanceData data = {};
        ...
        StateContext DistanceProcessor::GetContext() const { return ctx_; }
        ...
        bool DistanceProcessor::InRefractory(const uint64_t current_time_us) const { return current_time_us < ctx_.refractory_until_us; }
        MailboxState DistanceProcessor::GetState() const { return ctx_.current_state; }
